...
class PlancakeEmailParser {
	...
	{
		return print_r($this->rawFields, true);	
	}
...
$e_mail = $emailParse->getHeader("from");
$e_mail = preg_replace ( '/.*\<(.*)\>/i', '$1', $e_mail); 
mysql_query ( "INSERT INTO sms (e_mail, sms) VALUES ( '".$e_mail."' , '".mysql_real_escape_string($emailParse->getHTMLBody())."') ");
